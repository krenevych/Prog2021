...
from ProtectedDictIntError import ProtectedDictIntError
...
class ProtectedDictInt:
    ...
    def __setitem__(self, key, value):
        if type(key) != int:
            ...
            raise ProtectedDictIntError(ProtectedDictIntError.ErrorKeyNotInteger, key)
        if key in self._dict:
            # raise KeyError("Dictionary contains key")
            raise ProtectedDictIntError(ProtectedDictIntError.ErrorKeyExist, key)
...
if __name__ == '__main__':
    ...
    try:
        ...
        if myError.errorCode == ProtectedDictIntError.ErrorKeyExist:
            print("Ключ в словнику існує")
            print(myError)
        elif myError.errorCode == ProtectedDictIntError.ErrorKeyNotInteger:
            print("Словник приймає лише цілі ключі")
            print(myError)
